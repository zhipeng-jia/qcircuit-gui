class QcircuitGui.Editing.AddMeasure extends QcircuitGui.Editing.SelectRow
  ...
  operate: (circuit, i, j, extend) ->
    ...
    newItem = new QcircuitGui.Drawing.Measure(QcircuitGui.Helper.latexCode, extend + 1)
